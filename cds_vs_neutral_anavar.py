...
def sel_v_neu_anavar(mode, vcf, call, constraint, n, c, dfe, alg, nnoimp, maximp,
...
def main():
    ...
    parser.add_argument('-nnoimp', help='nnoimp value', default=1)
    parser.add_argument('-maximp', help='maximp value', default=3)
